...
export default function ProfilePage() {
    ...
    if (isLoading) {
        return (
            <div className="flex-1 bg-card rounded-lg p-6 flex flex-col min-h-0">
    ...
    if (error) {
        return (
            <div className="flex-1 bg-card rounded-lg p-6 flex flex-col items-center justify-center gap-4 text-center">
    ...
    if (!profileData) {
        return (
            <div className="flex-1 bg-card rounded-lg p-6 flex flex-col items-center justify-center text-center">
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                    <div className="flex items-center gap-4">
                        {user.image ? (
                            ...
                            <div className="flex h-20 w-20 items-center justify-center rounded-full bg-muted text-2xl font-bold text-white">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">Joined {getJoinedDate(user.createdAt)}</p>
                            {user.bio && (
                    ...
                    <button
                        ...
                        className={`rounded-full px-5 py-2 text-sm font-semibold transition-colors ${isActionDisabled ? 'cursor-not-allowed' : 'cursor-pointer'} ${isOwnProfile
                            ...
                            : isFollowing
                                ? 'border border-border bg-card text-white hover:bg-muted'
                                : 'bg-white text-black hover:bg-gray-200'
                            }`}
                    >
                        {actionLabel}
